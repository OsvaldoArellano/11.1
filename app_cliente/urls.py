...
urlpatterns = [
    ...
    path('cliente/<int:cliente_id>/vehiculo/agregar/', views.agregar_vehiculo, name='agregar_vehiculo'),
    path('cliente/<int:cliente_id>/vehiculo/<int:vehiculo_id>/eliminar/', views.eliminar_vehiculo, name='eliminar_vehiculo'),
]